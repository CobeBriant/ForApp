...
public class StudentServiceImpl extends BaseServiceImpl<Student> implements StudentService {
	...
	public Student selectStuByName(String name){
		String sql = "SELECT id,`NAME`,	`PASSWORD`,	cid FROM student WHERE	NAME = ? ";
		Student student = (Student)studentDao.queryForObject(sql,Student.class);
		return student;
	}
	
	@Override
	public String selectIDByStuName(String name){
