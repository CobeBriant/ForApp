...
<div class="head">
	<div class="head_logo">
		<img src="images/f7.png"> <span class="logo_content">歡飲登錄考試系統</span>
	</div>
	<!--显示登录的用户-->
	<div class="head_info">
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="student/index">通知页</a>
			</div>

			<div class="collapse navbar-collapse"
				id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="student/exam/list">考试任务清单</a></li>
					<li><a href="student/notes">参考记录</a></li>
